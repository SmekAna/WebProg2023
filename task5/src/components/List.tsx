...
import { setIsEdit } from "../features/movies/Slice";
    ...
    return (
        <>
            ...
            <div className="py-4 mt-4 border-t border-t-[#d9d9d9] flex items-center justify-between">
                ...
                <button
                    onClick={onEdit}
                    className="w-full md:w-auto h-8 px-3 flex items-center gap-2 text-xs text-[#ffffff] bg-primary transition duration-300 hover:bg-secondary btn_shadow rounded-lg text-center"
                >
